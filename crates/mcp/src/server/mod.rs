...
use crate::protocol::{
    ...
    McpPrompt, McpResource, McpToolDef, PromptGetParams, PromptGetResult, ResourceReadParams,
    ResourceReadResult, ServerCapabilities, ServerInfo, ToolCallParams, ToolCallResult, method,
};
...
mod tests {
    ...
    use super::resources::list_files_recursive;
    use super::*;
    use crate::protocol::{ResourceContent, ToolResultContent};
    use serde_json::json;
